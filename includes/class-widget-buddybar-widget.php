...
class Slushman_BuddyBar_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/buddybar-widget-form.php' );
	...
	function widget( $args, $instance ) {
		...
		if ( is_user_logged_in() ) {
			...
			include( plugin_dir_path( __FILE__ ) . 'partials/buddybar-widget.php' );

		} else {

			include( plugin_dir_path( __FILE__ ) . 'partials/buddybar-widget-login-form.php' );
	...
	private function reorder_array( $array ) {
		...
		$temp = array();
		$keys = array( 'activity', 'messages', 'friends', 'groups' );
